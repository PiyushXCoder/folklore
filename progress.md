...
- [ ] `pnpm tauri dev` smoke test — user to confirm live-reload now actually fires consistently in the running desktop app, across a few different editors (CLI-arg open, drag-drop, dialog too)
